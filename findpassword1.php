...
<div align="center" style="width: 50%;height: 20%;margin-left: auto;margin-right: auto;margin-top: 3%">
    <form action="findpassword2.php" method="get">
        <font size="4px" color="#5aa8ff">{$row['question']}</font><input style="border-top: transparent" class="inp" type="text" name="answer" placeholder="请回答您的安保问题...">
        <br>
        <br>
